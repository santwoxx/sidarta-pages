document.addEventListener('DOMContentLoaded', () => {
  ...
  const TEMPLATES = {
    ...
    clinica: { name: 'Clínica Médica', path: '../modelos/clinica-med/index.html' },
    cosmeticos: { name: 'Cosméticos Premium', path: '../modelos/cosmeticos-fem/index.html' },
    dentista: { name: 'Clínica Odontológica', path: '../modelos/clinica-dent/index.html' }
  };
